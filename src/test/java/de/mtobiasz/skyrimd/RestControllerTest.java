...
class RestControllerTest {
    ...
    void showRandomUser() throws SQLException, JsonProcessingException {
        var expectedUser = new User(UUID.fromString("22f9d818-9be5-425e-9468-9b16fc7edecb"), "John", null, "Winterhold", LocalDate.of(1999, 2, 12),"test user", "M");
    ...
    void getUsers() throws SQLException {
        ...
        expectedUsers.add(new User(UUID.fromString("22f9d818-9be5-425e-9468-9b16fc7edecb"), "John", null, "Winterhold", LocalDate.of(1999, 2, 12),"test user", "M"));
        expectedUsers.add(new User(UUID.fromString("b0d4af09-1671-4f1f-b876-d5120a0fb767"), "Jane", null, "Winterhold", LocalDate.of(1999, 2, 12),"test user", "M"));
    ...
    void getUsersById() throws SQLException, JsonProcessingException {
        ...
        ids.add(UUID.fromString("b0d4af09-1671-4f1f-b876-d5120a0fb767"));
        var expectedUsers = new ArrayList<User>();
        expectedUsers.add(new User(UUID.fromString("22f9d818-9be5-425e-9468-9b16fc7edecb"), "John", null, "Winterhold", LocalDate.of(1999, 2, 12),"test user", "M"));
        expectedUsers.add(new User(UUID.fromString("b0d4af09-1671-4f1f-b876-d5120a0fb767"), "Jane", null, "Winterhold", LocalDate.of(1999, 2, 12),"test user", "M"));
